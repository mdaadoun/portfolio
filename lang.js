(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "client_hero_btn_poc": "📅 Book Appointment / Flash Pilot (€490 excl. VAT)",
      "client_hero_btn_solutions": "💡 Discover Our Method (Extraction + Validation)",

      "client_rdv_badge": "📅 Appointment Booking",
      "client_rdv_title": "Schedule a Meeting or Reserve a Flash Pilot",
      "client_rdv_subtitle": "Select a time slot below to discuss your documentary needs or initiate a Flash Pilot.",
      "client_rdv_prompt": "Book a time slot directly in our online calendar to discuss your written specifications (DPGF / CCTP) or launch your Flash Pilot.",
      ...
      "client_offer3_desc": "<strong>Concept:</strong> Once your core tool is operational, add only the optional modules your business actually needs.<br><strong>🔎 RAG Search in Archives:</strong> Semantic search engine to find any clause in 3 seconds across your archived CCTPs/DTUs.<br><strong>🛠️ Workflows & Connectors:</strong> Custom integration with your existing business tools.<br><em>No extension is mandatory. Offered on custom quote upon request.</em>",
      "client_offer3_btn": "Explore RAG prototype ↗",
    ...
    fr: {
      ...
      "client_hero_btn_poc": "📅 Prendre RDV / Pilote Flash (490 € HT)",
      "client_hero_btn_solutions": "💡 Découvrir notre méthode (Extraction + Contrôle)",

      "client_rdv_badge": "📅 Prise de Rendez-vous",
      "client_rdv_title": "Planifier un Échange ou Réserver un Pilote Flash",
      "client_rdv_subtitle": "Sélectionnez un créneau dans l'agenda ci-dessous pour échanger directement sur vos besoins documentaires ou lancer un Pilote Flash.",
      "client_rdv_prompt": "Réservez un créneau directement dans notre agenda en ligne pour discuter de vos pièces écrites (DPGF / CCTP) ou lancer votre Pilote Flash.",
      ...
      "client_offer3_desc": "<strong>Principe :</strong> Une fois votre outil métier en place, ajoutez uniquement les briques optionnelles dont votre entreprise a réellement besoin.<br><strong>🔎 Recherche RAG dans les archives :</strong> Moteur de recherche sémantique pour retrouver une clause en 3 secondes dans vos anciens CCTP/DTU.<br><strong>🛠️ Workflows & Connecteurs :</strong> Intégration sur-mesure à vos outils métier et logiciels internes.<br><em>Aucune extension n'est obligatoire. Proposées sur devis après validation.</em>",
      "client_offer3_btn": "Explorer le prototype RAG ↗",
