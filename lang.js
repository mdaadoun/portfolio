(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "card4_btn": "Access Product Demo & Dashboard",
      "card5_title": "Multi-Agent Workflow Orchestrator",
      "card5_desc": "<strong>Problem:</strong> Complex multi-step task execution requiring dynamic tool calling.<br><strong>Architecture:</strong> CrewAI & AutoGen agent network with WebSockets and FastAPI event loop.<br><strong>Impact:</strong> Distributed decision making with deterministic state rollbacks.",
    ...
    fr: {
      ...
      "card4_btn": "Accéder à la Démo Produit & Dashboard",
      "card5_title": "Orchestrateur Multi-Agents",
      "card5_desc": "<strong>Problème :</strong> Exécution autonome de workflows complexes multi-outils.<br><strong>Architecture :</strong> Réseau d'agents CrewAI & AutoGen avec WebSockets et FastAPI.<br><strong>Impact :</strong> Prise de décision distribuée avec rollback d'état déterministe.",
