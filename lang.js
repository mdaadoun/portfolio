(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "client_pill_1": "⚡ Drastically reduce re-keying of DPGF & CCTP files",
      ...
      "client_offers_badge": "Pilot & Onboarding Journey",
      "client_offers_title": "Pragmatic Solutions Tested Directly on Your Own Files",
      "client_offers_subtitle": "Start on a live file, with no commitment to a broader integration.",
      
      "client_offer1_tag": "Q1 Flagship Offer",
      "client_offer1_title": "1. Live File Flash Pilot — €490 (excl. VAT)",
      "client_offer1_desc": "<strong>Concept:</strong> Provide 1 live document (PDF DPGF or CCTP) currently pending on your desk.<br><strong>48h Deliverables:</strong> Structured Excel/CSV file + Isolated Anomaly Report + Custom Loom video demo.<br><strong>Goal:</strong> Measure actual time savings on your own file before any integration.",
      "client_offer1_btn": "Request a Flash Pilot on my file ↗",

      "client_offer2_title": "2. Search & Enterprise Technical Memory",
      "client_offer2_desc": "<strong>Problem:</strong> Technical knowledge scattered across thousands of archived PDFs.<br><strong>Solution:</strong> Sovereign search engine querying your history of CCTPs and DTU standards in 3 seconds.<br><strong>Traceability:</strong> Every snippet points back to the exact page and source file.<br><em>Demonstration using test BTP data. Full deployment available upon request following Flash Pilot validation.</em>",
      "client_offer2_btn": "Explore interactive prototype ↗",

      "client_offer3_title": "3. Workflow Standardization",
      "client_offer3_desc": "<strong>Concept:</strong> Once the Flash Pilot is validated, creation of a custom UI or connector to process your recurring document flows.<br><strong>Onboarding:</strong> Integration into your existing environment & team workflow training.<br><strong>Scope:</strong> Custom quote following Flash Pilot validation.",
      "client_offer3_btn": "Discover the approach ↗",
    ...
    fr: {
      ...
      "client_offers_badge": "Parcours d'Accompagnement & Pilote",
      "client_offers_title": "Des Solutions Pragmatiques & Testables sur vos Propres Dossiers",
      "client_offers_subtitle": "Démarrez sur un dossier réel, sans engagement sur une intégration plus large.",
      
      "client_offer1_tag": "Offre Phare T1",
      "client_offer1_title": "1. Le Pilote Flash sur un Dossier Réel — 490 € HT",
      "client_offer1_desc": "<strong>Principe :</strong> Donnez-nous 1 vrai dossier (DPGF ou CCTP PDF) actuellement en attente sur votre bureau.<br><strong>Livrable sous 48h :</strong> Fichier Excel/CSV structuré + Rapport d'anomalies isolées + Démo vidéo Loom personnalisée.<br><strong>Objectif :</strong> Mesurer le gain réel sur votre propre dossier avant toute intégration.",
      "client_offer1_btn": "Demander un Pilote Flash sur mon dossier ↗",

      "client_offer2_title": "2. Recherche & Mémoire Technique d'Entreprise",
      "client_offer2_desc": "<strong>Problème :</strong> Information technique dispersée dans des milliers de PDF et dossiers archivés.<br><strong>Solution :</strong> Moteur de recherche interne interrogeant l'historique de vos anciens CCTP et normes DTU pour retrouver une clause en 3 secondes.<br><strong>Traçabilité :</strong> Chaque extrait retrouve la page et le document source exact.<br><em>Démonstration sur données de test BTP. Déploiement disponible sur devis après validation du Pilote Flash.</em>",
      "client_offer2_btn": "Explorer le prototype interactif ↗",

      "client_offer3_title": "3. Standardisation du Workflow",
      "client_offer3_desc": "<strong>Principe :</strong> Une fois le Pilote Flash validé sur vos dossiers, création d'une interface ou d'un connecteur sur-mesure pour traiter vos flux documentaires récurrents.<br><strong>Accompagnement :</strong> Intégration dans votre environnement existant et formation de vos équipes.<br><strong>Périmètre :</strong> Sur devis personnalisé après validation du Pilote.",
      "client_offer3_btn": "Découvrir la démarche ↗",
