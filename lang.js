(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "client_hero_desc": "Full traceability, uncertainty management, and zero manual data entry for building engineering and cost estimation teams.",
      "client_hero_btn_poc": "🚀 Order a Flash Pilot (€490 excl. VAT)",
      "client_hero_btn_solutions": "💡 Discover Our Method (Extraction + Validation)",
      "client_pill_1": "⚡ Stop re-keying DPGF & CCTP files",
      ...
      "client_tech_badge": "Under the Hood — Software Robustness",
      ...
      "client_acc1_title": "01. Deterministic Orchestration Engines",
      "client_acc1_desc": "Strict control of document flows and execution without infinite loops or fantasy text generation.",
      "client_acc2_title": "02. Secure Vector Databases",
      "client_acc2_desc": "Combines BM25 lexical keyword search and semantic matching to pinpoint exact clauses.",
      "client_acc3_title": "03. Data Anonymization & Security",
      "client_acc3_desc": "Sensitive data masking and strict Pydantic V2 schema validation.",
    ...
    fr: {
      ...
      "client_hero_desc": "Traçabilité totale, contrôle des incertitudes et zéro ressaisie manuelle pour vos équipes d'ingénierie et d'économie du bâtiment.",
      "client_hero_btn_poc": "🚀 Commander un Pilote Flash (490 € HT)",
      "client_hero_btn_solutions": "💡 Découvrir notre méthode (Extraction + Contrôle)",
      "client_pill_1": "⚡ Ne ressaisissez plus vos DPGF & CCTP",
      ...
      "client_tech_badge": "Sous le Capot — Robustesse Logicielle",
      ...
      "client_acc1_title": "01. Moteurs d'orchestration déterministes",
      "client_acc1_desc": "Contrôle strict des flux documentaires et exécution sans boucle ni texte fantaisiste.",
      "client_acc2_title": "02. Bases de données vectorielles sécurisées",
      "client_acc2_desc": "Combinaison de la recherche lexicale (BM25) et sémantique pour retrouver les clauses exactes.",
      "client_acc3_title": "03. Anonymisation & filtres de sécurité",
      "client_acc3_desc": "Masquage des données sensibles et contrôle strict des schémas via Pydantic V2.",
